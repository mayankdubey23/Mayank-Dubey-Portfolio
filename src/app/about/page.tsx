...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "mayankdubey0818@gmail.com",
    href: "mailto:mayankdubey0818@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/mayank-dubey23/",
    content: "/mayank-dubey23",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/mayankdubey23",
    content: "/mayankdubey23",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Mayank Dubey</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Mayank Dubey, a web developer focused on building clean,
              responsive websites and web applications. I enjoy turning design ideas into
              polished user experiences that work seamlessly on desktop and mobile.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me exploring new UI trends, studying
              modern web tools, or refining the next project that helps businesses stand out online.
            </p>
